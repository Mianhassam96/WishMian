        ...
        {stage === "message" && (
          <motion.div key="message" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2 }} style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "16px 24px 32px", textAlign: "center" }}>
              ...
              <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9, duration: 0.9 }} style={{ maxWidth: 400, width: "100%", background: "rgba(255,255,255,0.04)", border: `1px solid ${template.glowColor}22`, borderRadius: 22, padding: "22px 26px", boxShadow:   0 40px 10, backdropFilter: "blur(20px)", marginBottom: 18 }}>
